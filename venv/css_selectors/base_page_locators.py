...
class BasePageLocators():
    ...
    VIRTUAL_SPORTS_BTN = (By.CSS_SELECTOR, 'li[data-order="7"]')
    BETONGAMES_BTN = (By.CSS_SELECTOR, 'li[data-order="8"]')
    POKER_BTN = (By.CSS_SELECTOR, 'li[data-order="9"]')
    LIVE_BINGO_BTN = (By.CSS_SELECTOR, 'li[data-order="10"]')
